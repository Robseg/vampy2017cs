...
while dead == False:
	...
	#--------------------------------------------------------------------------------------------------------------------------------------------------
		if yaxis == 1 and xaxis == 0:
			if torch == True and bronzekey == True:
			...
			elif torch == True and bronzekey == False:
			...
			if torch == True and bronzekey == False:
			...
			elif torch == True and bronzekey == True:
				...
				north()
				if answer in ["west","West","W","w"] and doorone == False:
					print("The door is locked.")
				if answer in ["west","West","W","w"] and doorone == True:
					xaxis = xaxis - 1
				if answer in ["use key","use key on door", "use bronze key", "use bronze key on door"]:
					doorone = True
					print("The door is open")
			elif torch == False and bronzekey == False:
